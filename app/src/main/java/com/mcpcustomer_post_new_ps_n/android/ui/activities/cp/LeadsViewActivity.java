    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchRLID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LeadsViewActivity.this,SearchActivity.class));
            }
        });
        ...
        swipeID.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                crmAllActivitiesList(AppConstants.BASE_URL+"mobileapp/activitiesplanneddata" +"?cp_id=" + userID +"&act_id="+LeadsViewActivity.urlStr  +"&start=0");
                   ...
                   noDataTVID.setVisibility(View.VISIBLE);
                    ...
                    try {
                        ...
                        while (count < response.length()) {
                            ...
                            listAdapter=new LeadViewAdapter(LeadsViewActivity.this,crmAllResponses);
