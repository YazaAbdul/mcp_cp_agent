...
public class CreativesAdapterWithOut extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    FragmentCreativesWithOut activity;
    ...
    public CreativesAdapterWithOut(FragmentCreativesWithOut activity, ArrayList<CreativesResponse> creativesResponses, CreativeClickListener creativeClickListener, String cpPicStr) {
