...
public class PaidAdapter extends RecyclerView.Adapter<PaidAdapter.DueTransactionVH> {
    private ArrayList<_NewTransactionPaidResponse> dueResponses = new ArrayList<>();
    ...
    public PaidAdapter(Activity activity, ArrayList<_NewTransactionPaidResponse> dueResponses) {
    ...
    public void onBindViewHolder(@NonNull DueTransactionVH holder, int position) {
        ...
        holder.scheduleDateTVID.setText(dueResponses.get(position).getSchedule_date());
