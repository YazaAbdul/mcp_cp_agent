...
public class ViewImageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerBackRLID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Utilities.finishAnimation(ViewImageActivity.this);
            }
        });
        ...
        if (picUrl.equals("")) {
            ...
            ).load(picUrl).error(R.drawable.crmappicon).into(imageID);
        }

        if (picFrom.equals(AppConstants.IS_PIC_FROM_APPLICATION)) {
            bottomLLID.setVisibility(View.GONE);
        } else {
    ...
    private void documentUpdate(String picFrom, final ProgressBar pb, final AppCompatImageView image, final String picType) {
        ...
        call.enqueue(new Callback<DocumentsObj>() {
            ...
            public void onResponse(Call<DocumentsObj> call, Response<DocumentsObj> response) {
                ...
                if (response.body() != null && response.code() == 200) {
                    ...
                    if (documentsObj.getStatus() == 1) {
                        ...
                        Utilities.customMessage(mainViewLLID, ViewImageActivity.this, "Pic not Uploaded");
                    }
                } else {
                    image.setVisibility(View.VISIBLE);
                    image.setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_cancel_music));
            ...
            public void onFailure(Call<DocumentsObj> call, Throwable t) {
                Utilities.customMessage(mainViewLLID, ViewImageActivity.this, "Error : " + t.getMessage());
                image.setVisibility(View.VISIBLE);
                image.setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_cancel_music));
            }
        });
    ...
    private void picUpload(final String picType) {
        ...
        ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        Call<DocumentsObj> call = apiInterface.uploadBankDocuments(imageBody, picType, customerIDStr);
        call.enqueue(new Callback<DocumentsObj>() {
            @Override
            public void onResponse(Call<DocumentsObj> call, Response<DocumentsObj> response) {
                ...
                if (response.body() != null && response.code() == 200) {
                    ...
                    if (documentsObj.getStatus() == 1) {
                        Utilities.finishAnimation(ViewImageActivity.this);
                        MySharedPreferences.setPreference(ViewImageActivity.this, "" + AppConstants.REFRESH_PAGE, "YES");
                        //Utilities.customMessage(mainViewLLID, ViewImageActivity.this, "" + documentsObj.getMsg());
                        Toast.makeText(ViewImageActivity.this, "" + documentsObj.getMsg(), Toast.LENGTH_SHORT).show();
                    } else {
                        Utilities.customMessage(mainViewLLID, ViewImageActivity.this, "" + documentsObj.getMsg());
                        Utilities.customMessage(mainViewLLID, ViewImageActivity.this, "Pic not Uploaded");
                    }
    ...
    private void showAlert() {
        ...
        cameraTVID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dexter.withActivity(ViewImageActivity.this).withPermissions(Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE).withListener(new MultiplePermissionsListener() {
                    @Override
        ...
        galleryTVID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(ViewImageActivity.this, android.Manifest.permission.READ_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED
                        && ContextCompat.checkSelfPermission(ViewImageActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED) {
