...
public class LeadsCompletedView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cp_activity_leadscomplete);
        ...
        backRLID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Utilities.finishAnimation(LeadsCompletedView.this);
            }
        });
        ...
        searchRLID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LeadsCompletedView.this,SearchActivity.class));
            }
        });
        ...
        swipeID.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                crmAllActivitiesList(AppConstants.BASE_URL+"mobileapp/activitiescompleteddata" +"?cp_id=" + userID +"&act_id="+LeadsCompletedView.urlStr  +"&start=0");
    ...
    public void crmAllActivitiesList(String url) {
                ...
                if (response == null) {
                    ...
                    try {
                        ...
                        while (count < response.length()) {
                            ...
                            listAdapter=new LeadViewAdapter(LeadsCompletedView.this,crmAllResponses);
        ...
        AppSingleton.getInstance(LeadsCompletedView.this).addToRequestQueue(arrayRequest, "");
    }
