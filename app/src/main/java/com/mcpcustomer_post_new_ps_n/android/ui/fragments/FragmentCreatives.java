...
import com.mcpcustomer_post_new_ps_n.android.ui.adapter.CreativesAdapter;
 ...
 */
public class FragmentCreatives extends Fragment implements CreativesAdapter.CreativeClickListener {
    ...
    private void loadCreatives() {
        ...
        adapter = new CreativesAdapter(FragmentCreatives.this,creativesResponses, FragmentCreatives.this,cpPicStr);
