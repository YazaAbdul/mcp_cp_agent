...
public class ViewAadharCardImage extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_aadhar_card_image);
        ...
        headerBackRLID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Utilities.finishAnimation(ViewAadharCardImage.this);
            }
        });
    ...
    private void documentUpdate(String picFrom, final ProgressBar pb, final AppCompatImageView image, final String picType) {
        ...
        call.enqueue(new Callback<DocumentsObj>() {
            ...
            public void onResponse(Call<DocumentsObj> call, Response<DocumentsObj> response) {
                ...
                if (response.body() != null && response.code() == 200) {
                    ...
                    if (documentsObj.getStatus() == 1) {
                        ...
                        Utilities.customMessage(mainViewLLID, ViewAadharCardImage.this, "" + documentsObj.getMsg());
                    } else {
                        Utilities.customMessage(mainViewLLID, ViewAadharCardImage.this, "" + documentsObj.getMsg());
                        image.setVisibility(View.VISIBLE);
                        image.setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_cancel_music));
                        Utilities.customMessage(mainViewLLID, ViewAadharCardImage.this, "Pic not Uploaded");
                    }
                } else {
                    image.setVisibility(View.VISIBLE);
                    image.setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_cancel_music));
            ...
            public void onFailure(Call<DocumentsObj> call, Throwable t) {
                Utilities.customMessage(mainViewLLID, ViewAadharCardImage.this, "Error : " + t.getMessage());
                image.setVisibility(View.VISIBLE);
                image.setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_cancel_music));
            }
        });
    ...
    private void picUpload() {
        ...
        if (selectImagePath.equalsIgnoreCase("null")) {
            reqFile = RequestBody.create(MediaType.parse("multipart/form-data"), "");
            imageBody = MultipartBody.Part.createFormData("address_proof", "", reqFile);
        } else {
            reqFile = RequestBody.create(MediaType.parse("multipart/form-data"), file);
            imageBody = MultipartBody.Part.createFormData("address_proof", file.getName(), reqFile);
        }

        ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        Call<DocumentsObj> call = apiInterface.uploadaddressproof(imageBody, customerIDStr);
        call.enqueue(new Callback<DocumentsObj>() {
            @Override
            public void onResponse(Call<DocumentsObj> call, Response<DocumentsObj> response) {
                ...
                if (response.body() != null && response.code() == 200) {
                    ...
                    if (documentsObj.getStatus() == 1) {
                        Utilities.finishAnimation(ViewAadharCardImage.this);
                        MySharedPreferences.setPreference(ViewAadharCardImage.this, "" + AppConstants.REFRESH_PAGE, "YES");
                        //Utilities.customMessage(mainViewLLID, ViewImageActivity.this, "" + documentsObj.getMsg());
                        Toast.makeText(ViewAadharCardImage.this, "" + documentsObj.getMsg(), Toast.LENGTH_SHORT).show();
                    } else {
                        Utilities.customMessage(mainViewLLID, ViewAadharCardImage.this, "" + documentsObj.getMsg());
                        Utilities.customMessage(mainViewLLID, ViewAadharCardImage.this, "Pic not Uploaded");
                    }
    ...
    private void showAlert() {
        ...
        cameraTVID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dexter.withActivity(ViewAadharCardImage.this).withPermissions(Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE).withListener(new MultiplePermissionsListener() {
                    @Override
        ...
        galleryTVID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(ViewAadharCardImage.this, android.Manifest.permission.READ_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED
                        && ContextCompat.checkSelfPermission(ViewAadharCardImage.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(ViewAadharCardImage.this,
