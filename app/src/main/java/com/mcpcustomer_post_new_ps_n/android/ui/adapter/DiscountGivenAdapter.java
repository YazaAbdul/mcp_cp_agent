...
public class DiscountGivenAdapter extends RecyclerView.Adapter<DiscountGivenAdapter.DueTransactionVH> {
    private ArrayList<_NewTrasactionDiscountResponse> dueResponses = new ArrayList<>();
    ...
    public DiscountGivenAdapter(Activity activity, ArrayList<_NewTrasactionDiscountResponse> dueResponses) {
    ...
    public void onBindViewHolder(@NonNull DueTransactionVH holder, int position) {
        ...
        holder.particularTVID.setText(dueResponses.get(position).getDiscount_type());
        holder.scheduleAmountTVID.setText("\u20B9" + dueResponses.get(position).getDiscount_amount());
